...
function DestinationContainer(props) {
    ...
    return (
        <div className={styles.destinationContainer}>
            <p className={`${styles.towards} ${mainColor}`}>towards</p>
            <p className={`${styles.destinationCity} ${mainColor}`}>{props.destinationCity}</p>
            <p className={`${styles.destinationStopName} ${mainColor}`}>{renderDestStopName ? props.destinationStopName : ''}</p>
        </div>
    )
}
