...
function Bullet(props) {
    ...
    bulletMap.set('bulletBahn1', bulletBahn1.src);
    bulletMap.set('bulletBahn1X', bulletBahn1X.src);
    bulletMap.set('bulletBahn1A', bulletBahn1A.src);
    bulletMap.set('bulletBahn1AX', bulletBahn1AX.src);
    bulletMap.set('bulletBahn1B', bulletBahn1B.src);
    bulletMap.set('bulletBahn1BX', bulletBahn1BX.src);
    bulletMap.set('bulletBahn1C', bulletBahn1C.src);
    bulletMap.set('bulletBahn1CX', bulletBahn1CX.src);
    bulletMap.set('bulletBahn1D', bulletBahn1D.src);
    bulletMap.set('bulletBahn1DX', bulletBahn1DX.src);
    bulletMap.set('bulletBahn1E', bulletBahn1E.src);
    bulletMap.set('bulletBahn1EX', bulletBahn1EX.src);
    bulletMap.set('bulletBahn1F', bulletBahn1F.src);
    bulletMap.set('bulletBahn1FX', bulletBahn1FX.src);
    bulletMap.set('bulletBahn1G', bulletBahn1G.src);
    bulletMap.set('bulletBahn1GX', bulletBahn1GX.src);
    bulletMap.set('bulletBahn1H', bulletBahn1H.src);
    bulletMap.set('bulletBahn1HX', bulletBahn1HX.src);
    bulletMap.set('bulletBahn1I', bulletBahn1I.src);
    bulletMap.set('bulletBahn1IX', bulletBahn1IX.src);
    bulletMap.set('bulletBahn1J', bulletBahn1J.src);
    bulletMap.set('bulletBahn1JX', bulletBahn1JX.src);
    bulletMap.set('bulletBahnRF', bulletBahnRF.src);
    bulletMap.set('bulletBahnWV', bulletBahnWV.src);
    bulletMap.set('bulletBahnZQ', bulletBahnZQ.src);
    
    bulletMap.set('bulletRail1', bulletRail1.src);
    bulletMap.set('bulletRail2', bulletRail2.src);
    bulletMap.set('bulletRail3', bulletRail3.src);
    bulletMap.set('bulletRail4', bulletRail4.src);
    bulletMap.set('bulletRail6', bulletRail6.src);
    bulletMap.set('bulletRail7', bulletRail7.src);
    bulletMap.set('bulletRail11', bulletRail11.src);
    bulletMap.set('bulletRail12', bulletRail12.src);
    bulletMap.set('bulletRail13', bulletRail13.src);
    bulletMap.set('bulletRail14', bulletRail14.src);
    bulletMap.set('bulletRail15', bulletRail15.src);
    bulletMap.set('bulletRail16', bulletRail16.src);
    bulletMap.set('bulletRail17', bulletRail17.src);
    bulletMap.set('bulletRail18', bulletRail18.src);
    bulletMap.set('bulletRail20', bulletRail20.src);
    bulletMap.set('bulletRail21', bulletRail21.src);
    bulletMap.set('bulletRail22', bulletRail22.src);
    bulletMap.set('bulletRail23', bulletRail23.src);
    bulletMap.set('bulletRail24', bulletRail24.src);
    bulletMap.set('bulletRail26', bulletRail26.src);
    bulletMap.set('bulletRail29', bulletRail29.src);
    bulletMap.set('bulletRail32', bulletRail32.src);
    bulletMap.set('bulletRail33', bulletRail33.src);
    bulletMap.set('bulletRail34', bulletRail34.src);
    bulletMap.set('bulletRail36', bulletRail36.src);
    bulletMap.set('bulletRail37', bulletRail37.src);
    bulletMap.set('bulletRail38', bulletRail38.src);
    bulletMap.set('bulletRail39', bulletRail39.src);
    bulletMap.set('bulletRail40', bulletRail40.src);
    bulletMap.set('bulletRail42', bulletRail42.src);
    bulletMap.set('bulletRail43', bulletRail43.src);
    bulletMap.set('bulletRail46', bulletRail46.src);
    bulletMap.set('bulletRail48', bulletRail48.src);
    bulletMap.set('bulletRail49', bulletRail49.src);
    bulletMap.set('bulletRail50', bulletRail50.src);
    bulletMap.set('bulletRail51', bulletRail51.src);
    bulletMap.set('bulletRail52', bulletRail52.src);
    bulletMap.set('bulletRail54', bulletRail54.src);
    bulletMap.set('bulletRail55', bulletRail55.src);
    bulletMap.set('bulletRail56', bulletRail56.src);
    bulletMap.set('bulletRail57', bulletRail57.src);
    bulletMap.set('bulletRail58', bulletRail58.src);
    bulletMap.set('bulletRail59', bulletRail59.src);
    bulletMap.set('bulletRail63', bulletRail63.src);
    bulletMap.set('bulletRail64', bulletRail64.src);
    bulletMap.set('bulletRail66', bulletRail66.src);
    bulletMap.set('bulletRail66X', bulletRail66X.src);
    bulletMap.set('bulletRail67', bulletRail67.src);
    bulletMap.set('bulletRail69', bulletRail69.src);
    bulletMap.set('bulletRail70', bulletRail70.src);
    bulletMap.set('bulletMCR1', bulletMCR1.src);
    bulletMap.set('bulletMCR1A', bulletMCR1A.src);
    bulletMap.set('bulletMCR2', bulletMCR2.src);
    bulletMap.set('bulletMCR3', bulletMCR3.src);
    bulletMap.set('bulletMCR4', bulletMCR4.src);
    bulletMap.set('bulletMCR5', bulletMCR5.src);
    bulletMap.set('bulletMCR6', bulletMCR6.src);
    bulletMap.set('bulletMCR7', bulletMCR7.src);
    bulletMap.set('bulletMCR8', bulletMCR8.src);
    bulletMap.set('bulletMCR9', bulletMCR9.src);
