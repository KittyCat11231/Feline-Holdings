            ...
            <div className={styles.container}>
                <div className={styles.post} ref={post1}>
                    <CarouselPost
                        ...
                        imgWidthDesktop={props.propsObj.post1.imgWidthDesktop}
                        imgMaxWidthDesktop={props.propsObj.post1.imgMaxWidthDesktop}
                        imgHeightDesktop={props.propsObj.post1.imgHeightDesktop}
                        imgMaxHeightDesktop={props.propsObj.post1.imgMaxHeightDesktop}
                        imgTransformDesktop={props.propsObj.post1.imgTransformDesktop}
                ...
                <div className={styles.post} ref={post2}>
                    <CarouselPost
                        ...
                        imgWidthDesktop={props.propsObj.post2.imgWidthDesktop}
                        imgMaxWidthDesktop={props.propsObj.post2.imgMaxWidthDesktop}
                        imgHeightDesktop={props.propsObj.post2.imgHeightDesktop}
                        imgMaxHeightDesktop={props.propsObj.post2.imgMaxHeightDesktop}
                        imgTransformDesktop={props.propsObj.post2.imgTransformDesktop}
                ...
                <div className={styles.post} ref={post3}>
                    <CarouselPost
                        ...
                        imgWidthDesktop={props.propsObj.post3.imgWidthDesktop}
                        imgMaxWidthDesktop={props.propsObj.post3.imgMaxWidthDesktop}
                        imgHeightDesktop={props.propsObj.post3.imgHeightDesktop}
                        imgMaxHeightDesktop={props.propsObj.post3.imgMaxHeightDesktop}
                        imgTransformDesktop={props.propsObj.post3.imgTransformDesktop}
